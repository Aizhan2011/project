    ...
    <footer>
      <div className="container">
        ...
        <div className="navigation">
          <h3 className="title__navigation">НАВИГАЦИЯ</h3>
        ...
        <div className="our__contacts">
          <h3 className="title__navigation">Наши контакты</h3>
          <div className="footer__line"></div>
          <ul className="main__contacts">
            <li>
              <a href="#">г. Астана, район Есиль, пр.Тұран, здание 49</a>
            </li>
            <li>
            ...
            <li>
              <a href="#" type="email">
                ciei2022@mail.ru centerciei.edu@gmail.com
              </a>
            </li>
          </ul>
        </div>
      ...
      <div className="design">ABC DESIGN</div>
    </footer>
  );
}
